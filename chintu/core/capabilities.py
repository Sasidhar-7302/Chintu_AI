...
class Capability:
    ...
    def matches(self, text: str) -> bool:
        ...
        for trigger in self.triggers:
            ...
            if trigger_lower in text_lower or trigger_lower in normalized:
    ...
    def get_match_score(self, text: str) -> float:
        ...
        matches = sum(1 for t in self.triggers if t.lower() in text_lower)
        return matches / len(self.triggers) if self.triggers else 0
