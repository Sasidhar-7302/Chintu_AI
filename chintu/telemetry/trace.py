...
class StructuredJsonFormatter(logging.Formatter):
    ...
    Output format:
    {
        ...
        "level": "INFO",
        "logger": "chintu.core.model_router",
...
class StructuredLogger:
    ...
    Usage:
        log = StructuredLogger("chintu.core")
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                logging.getLogger(f"chintu.timing.{component_name}").debug(
                ...
                duration_ms = (time.time() - start) * 1000
                logging.getLogger(f"chintu.timing.{component_name}").error(
...
def setup_json_logging(level: int = logging.INFO, log_file: Optional[str] = None):
    ...
    root.info("Structured JSON logging configured")
