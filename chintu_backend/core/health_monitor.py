        ...
        try:
            ...
            if not has_input and not has_output:
                return HealthCheck(
                    component="audio",
                    status=HealthStatus.UNHEALTHY,
                    message="No input or output audio devices detected",
                    timestamp=datetime.now().isoformat(),
            ...
            if not has_input:
                return HealthCheck(
                    ...
                    timestamp=datetime.now().isoformat(),
                    details={"device_count": len(devices), "has_output": has_output},
                )
            if not has_output:
                return HealthCheck(
                    component="audio",
                    ...
                    timestamp=datetime.now().isoformat(),
                    details={"device_count": len(devices), "has_input": has_input},
                )
